/**
 * Design tokens for Fund module (ui-ux-pro-max: fintech dashboard).
 * Primary amber, CTA violet, WCAG contrast, 200ms transitions.
 */
...
export const fundTokens = {
  ...
  /** Cards: Bento-style, subtle shadow, visible border light/dark */
  card: {
  ...
  /** Buttons: primary=amber (trust), cta=violet (action), focus ring */
  btn: {
  ...
  /** Status: icon + label (accessibility - not color only) */
  status: {
