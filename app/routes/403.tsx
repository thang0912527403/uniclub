        ...
        <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50 flex items-center justify-center px-4">
            <div className="max-w-4xl w-full text-center relative">
                ...
                <div className="mb-8">
                    <div className="inline-flex items-center justify-center w-64 h-64 bg-orange-100 rounded-full mb-6">
                        <div className="text-center">
                            <i className="fas fa-lock text-orange-500 text-6xl mb-4"></i>
                            <div className="text-orange-600 text-8xl font-bold">403</div>
                        </div>
                    </div>
                </div>
                ...
                <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                    Rất tiếc, bạn không có quyền để truy cập vào trang này.
