            ...
            <main className={`pt-24 px-6 py-8 bg-gray-50 dark:bg-gray-900 transition-all duration-300 min-h-screen ${isSidebarOpen ? 'ml-64' : 'ml-0'
                ...
                <div className="w-full">
                    ...
                    <div className="mb-6">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Tạo Câu Lạc Bộ Mới</h2>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Điền thông tin để tạo câu lạc bộ của bạn</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-end gap-3 pt-4">
                            ...
                            >
                                {isLoading ? 'Đang tạo...' : 'Tạo Câu Lạc Bộ'}
                            </button>
                        </div>
                    </form>
                </div>
