    ...
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 animate-slideUp">
      <div className="flex items-center gap-2 px-5 py-3 bg-gray-900 dark:bg-gray-700 text-white rounded-2xl shadow-2xl shadow-gray-900/30 border border-gray-700 dark:border-gray-600 flex-wrap justify-center">
        ...
        <div className="flex items-center gap-2 mr-1">
          ...
          <span className="text-sm font-medium text-gray-300 whitespace-nowrap">đã chọn</span>
        </div>
        ...
        {activeTab === 'Scheduled' && onConfirmAll && (
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl text-sm font-medium transition-all hover:shadow-md whitespace-nowrap"
          >
            <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
