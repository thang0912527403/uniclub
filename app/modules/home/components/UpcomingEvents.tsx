                    ...
                    {events.map((event) => (
                        ...
                        >
                            ...
                            <div className="bg-gradient-to-br from-orange-500 to-orange-600 text-white p-6 flex flex-col items-center justify-center min-w-[100px]">
                                ...
                                <div className="text-sm uppercase font-medium">{event.date.month}</div>
                            </div>
                            ...
                            <div className="flex-1 p-6">
                                ...
                                <button className="mt-4 bg-orange-500 hover:bg-orange-600 text-white px-5 py-2 rounded-lg text-sm font-medium transition-all duration-300 hover:shadow-lg cursor-pointer">
                                    Đăng ký ngay
                                </button>
                            </div>
                        </div>
