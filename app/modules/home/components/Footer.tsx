            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400">
                            <li><a href="#" className="hover:text-orange-500 transition-colors">Về UniClubs</a></li>
                            <li><a href="#" className="hover:text-orange-500 transition-colors">Câu lạc bộ</a></li>
                            <li><a href="#" className="hover:text-orange-500 transition-colors">Sự kiện</a></li>
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            <input
                                ...
                                className="flex-1 px-4 py-2 rounded-lg bg-gray-800 border border-gray-700 focus:border-orange-500 focus:outline-none text-sm"
                            />
                ...
                <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-6 text-sm text-gray-400">
                        ...
                        <a href="#" className="hover:text-orange-500 transition-colors">Quyền riêng tư</a>
