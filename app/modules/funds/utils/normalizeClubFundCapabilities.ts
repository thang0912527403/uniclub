...
export function normalizeClubFundCapabilitiesFromApi(
  ...
  return {
    ...
    hasDeleteFinancePolicy: pickClubFundBooleanFlag(
      rawCap,
      'hasDeleteFinancePolicy',
      'HasDeleteFinancePolicy',
      false,
    ),
    canSoftDeleteFund: pickClubFundBooleanFlag(
      rawCap,
      'canSoftDeleteFund',
      'CanSoftDeleteFund',
      false,
    ),
    canViewSoftDeletedFunds: pickClubFundBooleanFlag(
      rawCap,
      'canViewSoftDeletedFunds',
      'CanViewSoftDeletedFunds',
      false,
    ),
