    ...
    >
      ...
      >
        <div className="flex items-center gap-4 mb-4">
          <div
            className={`w-12 h-12 rounded-full flex items-center justify-center ${willActivate ? "bg-green-100 dark:bg-green-900" : "bg-red-100 dark:bg-red-900"}`}
          >
            <i
              className={`fas ${willActivate ? "fa-check-circle text-green-600 dark:text-green-400" : "fa-ban text-red-600 dark:text-red-400"} text-xl`}
            ></i>
          </div>
          <div>
        ...
        <div className="flex gap-3 justify-end">
          ...
          <button
            onClick={onConfirm}
            disabled={isLoading}
            className={`px-5 cursor-pointer py-2 rounded-lg text-white font-semibold transition-colors flex items-center gap-2 ${
              willActivate
...
export default function ClubsModule() {
  ...
  useEffect(() => {
    setPageIndex("1");
  }, [statusFilter, visibilityFilter, pageSize]);
  ...
  const handleConfirm = async () => {
    ...
    try {
      await toggleStatus({
        id: confirmClub.clubId,
        isActive: !confirmClub.isActive,
      }).unwrap();
      showNotification({
        type: "success",
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
              {[
                ...
                },
                {
                  ...
                  value: clubs.reduce((s, c) => s + c.memberCount, 0),
                  color: "bg-green-500",
                ...
                {
                  label: "Công khai",
                  value: clubs.filter((c) => c.isPublic).length,
                  color: "bg-orange-500",
                  icon: "fa-globe",
                },
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5 mb-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                  ...
                  <button
                    className="px-4 py-2 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors cursor-pointer text-sm font-semibold whitespace-nowrap"
                  ...
                  >
                    ...
                    <div className="h-32 bg-gradient-to-br from-blue-500 to-purple-600 relative overflow-hidden">
                      ...
                      <div className="absolute top-3 left-3 flex gap-1.5">
                        <span
                          className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${club.isActive ? "bg-green-500 text-white" : "bg-gray-500 text-white"}`}
                        >
