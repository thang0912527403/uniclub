...
export const baseApi = createApiWithBaseUrl(API_URLS.MAIN_SERVICE, 'api', ['RecruitmentCampaign', 'Dashboard', 'Club', 'User', 'Notification', 'Interview', 'Application', 'ClubRole', 'Policy', 'Department', 'Member', 'Notification']);
